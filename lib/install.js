...
function* install(args, config) {
  console.log('');
  console.log(color.red('spm 源（http://spm.alipay-inc.com/）将于 2019.3.15 下线'));
  console.log(color.red('请参考 https://yuque.antfin-inc.com/yunqian/blog/qlp10c 进行迁移，如有疑问请钉钉联系 @云谦'));
  console.log('');
